...
- (instancetype)init {
    if (self = [super init]) {
        ...
        // 布局
        _tarbarLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 70)];
        _tarbarLabel.text = @"欢迎收听";
        _tarbarLabel.textAlignment = NSTextAlignmentCenter;
        [self addSubview:_tarbarLabel];
        UIImageView *backgoundIV = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"tabbar_np_normall"]];
